...
def main(arg1):
    ...
    # if not os.path.exists("/home/yzc/llamawork/my_faiss_store.faiss"):
    #     docs = []  # Load your documents here
    ...
    while True:
        ...
        # docs = vector_store.similarity_search_with_score(prompt)
        # context = [doc[0].page_content for doc in docs if doc[1] < 500]
        # print("Context from FAISS:", context)

        # if context:
        #     prompt = "已知" + str(context) + "，你可以稍微参考以上资料回复：" + prompt
        ...
        for cur_response in generate_interactive(
            ...
            if (len(responses) > 100) : break
        print(responses[-1])

        # Add robot response to chat history
        chat_history.append({
            'role': 'robot',
            'content': responses[-1],  # Last response as the final response
        })
